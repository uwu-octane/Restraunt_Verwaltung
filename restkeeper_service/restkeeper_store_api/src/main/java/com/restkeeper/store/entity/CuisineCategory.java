...
@ApiModel(value="CuisineCategory", description="菜品及套餐分类")
@TableName(value = "t_category",resultMap = "BaseResultMap")
public class CuisineCategory extends BaseStoreEntity implements Serializable {
    ...
    @ApiModelProperty(value = "Cuisine List")
