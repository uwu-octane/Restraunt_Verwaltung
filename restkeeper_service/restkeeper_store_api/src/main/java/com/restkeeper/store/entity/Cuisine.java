...
@ApiModel(value="Cuisine", description="菜品")
@TableName(value = "t_dish", resultMap = "BaseResultMap")
public class Cuisine extends BaseStoreEntity implements Serializable{
    ...
    @ApiModelProperty(value = "attached category obj")
    ...
    @TableField(exist = false)
    private List<CuisineFlavor> flavorList;
